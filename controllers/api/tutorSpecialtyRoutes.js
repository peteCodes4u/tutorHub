...
// delete records from the tutor_specialty table
    ...
    try{
       const deletedSpecialty = await TutorSpecialty.destroy({
        ...
        if (deletedSpecialty === 0) {
            return res.status(404).json({ message: "Sorry, there are no records of this specialty associated with your user" });
        }
